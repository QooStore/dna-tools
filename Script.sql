...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='캐릭터 특징 태그 목록';
...
INSERT INTO `character_features` VALUES (1,1,'dps'),(2,1,'weaponDmg'),(3,1,'consonanceWeapon');
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='캐릭터 패시브 강화 업그레이드 항목';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `character_stats` VALUES (1,251,1255,300,150,0.00,0.00);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='캐릭터 기본 정보 (루트 테이블)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `characters` VALUES (1,'berenica','베레니카','umbro','/images/characters/berenica_v1.png','/images/element_icon/umbro.png','/images/character_list/berenica.png','sword','dualPistols','2026-01-13 14:08:10');
...
INSERT INTO `common_code_labels` VALUES ('ATTACK_TYPE','slash','베기'),('ATTACK_TYPE','smash','진동'),('ATTACK_TYPE','spike','관통'),('ELEMENT','anemo','바람'),('ELEMENT','electro','번개'),('ELEMENT','hydro','물'),('ELEMENT','lumino','빛'),('ELEMENT','pyro','불'),('ELEMENT','umbro','어둠'),('FEATURE','consonanceWeapon','동조 무기'),('FEATURE','control','제어'),('FEATURE','def','방어'),('FEATURE','dps','딜러'),('FEATURE','heal','치료'),('FEATURE','maxHp','최대 HP'),('FEATURE','maxSanity','최대 정신력'),('FEATURE','sanityRecovery','정신력 회복'),('FEATURE','shield','실드'),('FEATURE','skillDmg','스킬 대미지'),('FEATURE','summon','소환물'),('FEATURE','support','서포터'),('FEATURE','weaponDmg','무기 대미지'),('STAT','attack','공격력'),('STAT','defense','방어력'),('STAT','hp','체력'),('STAT','maxMentality','최대 정신력'),('STAT','morale','격양'),('STAT','resolve','필사'),('WEAPON','assaultRifle','돌격소총'),('WEAPON','bow','활'),('WEAPON','dualBlades','쌍도'),('WEAPON','dualPistols','쌍권총'),('WEAPON','greatsword','대검'),('WEAPON','grenadeLauncher','핸드 캐논'),('WEAPON','katana','대도'),('WEAPON','pistol','권총'),('WEAPON','polearm','장병기'),('WEAPON','shotgun','산탄총'),('WEAPON','sword','한손검'),('WEAPON','whipsword','칼날 채찍'),('WORD','attack','공격력'),('WORD','attackSpeed','공격 속도'),('WORD','attackType','공격 타입'),('WORD','category','카테고리'),('WORD','critDamage','치명타 피해'),('WORD','critRate','치명타 확률'),('WORD','element','속성'),('WORD','feature','특성'),('WORD','meleeProficiency','근거리 무기 마스터리'),('WORD','rangedProficiency','원거리 무기 마스터리'),('WORD','triggerProbability','발동 확률'),('WORD','weaponType','무기 타입');
...
INSERT INTO `common_codes` VALUES ('ATTACK_TYPE','slash'),('ATTACK_TYPE','smash'),('ATTACK_TYPE','spike'),('ELEMENT','anemo'),('ELEMENT','electro'),('ELEMENT','hydro'),('ELEMENT','lumino'),('ELEMENT','pyro'),('ELEMENT','umbro'),('FEATURE','consonanceWeapon'),('FEATURE','control'),('FEATURE','def'),('FEATURE','dps'),('FEATURE','heal'),('FEATURE','maxHp'),('FEATURE','maxSanity'),('FEATURE','sanityRecovery'),('FEATURE','shield'),('FEATURE','skillDmg'),('FEATURE','summon'),('FEATURE','support'),('FEATURE','weaponDmg'),('STAT','attack'),('STAT','defense'),('STAT','hp'),('STAT','maxMentality'),('STAT','morale'),('STAT','resolve'),('WEAPON','assaultRifle'),('WEAPON','bow'),('WEAPON','dualBlades'),('WEAPON','dualPistols'),('WEAPON','greatsword'),('WEAPON','grenadeLauncher'),('WEAPON','katana'),('WEAPON','pistol'),('WEAPON','polearm'),('WEAPON','shotgun'),('WEAPON','sword'),('WEAPON','whipsword'),('WORD','attack'),('WORD','attackSpeed'),('WORD','attackType'),('WORD','category'),('WORD','critDamage'),('WORD','critRate'),('WORD','element'),('WORD','feature'),('WORD','meleeProficiency'),('WORD','rangedProficiency'),('WORD','triggerProbability'),('WORD','weaponType');
...
INSERT INTO `consonance_weapons` VALUES (1,'melee','sword','slash',361.50,12.00,150.00,1.00,50.00);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='캐릭터 근원 단계 정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `introns` VALUES (1,1,1,'스파이럴 점프와 [잔광] 시전 시, 자신은 1단계의 스킬 효율 8% 상승 효과를 획득한다. 지속 시간 12초, 최대 3단계 중첩.'),(2,1,2,'HP 비율이 잣힌보다 낮은 대상에게 입히는 대미지 30% 상승.'),(3,1,3,'[잔광] 레벨+2, [회전] 레벨+1'),(4,1,4,'자신의 콤보 레벨에 따라 공격이 상승한다. 레벨당 20% 상승.'),(5,1,5,'[어둠의 불꽃] 레벨+2, [회전] 레벨+1'),(6,1,6,'[어둠의 불꽃] 사용 후, 검기 발동 시 일정 확률로 1개의 검기를 추가로 생성한다. 확률은 [이미르] 발동 확률 속성치의 25.0%');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='캐릭터 스킬 정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `skills` VALUES (1,1,'어둠의 불꽃','버프','근접 무기를 [이미르]로 교체하여 1개의 검기를 날리고, [이미르]로 기본 공격을 할 때 공격 방향으로 검기를 날린다. [이미르]를 사용하는 동안 자신이 대미지를 받을 시 경직되지 않으며, 정신력이 지속적으로 소모되고, 정신력이 0이 되거나 해당 스킬을 다시 사용하면 [이미르]를 회수한다.'),(2,1,'회전','패시브','[잔광]이나 한손검으로 대미지를 입힐 시, 일정 확률로 정신력을 회복한다.');
...
-- Dump completed on 2026-01-17 22:58:26
